...
QJsonObject Serialize::FileListSerialize(QMap<int, QString> files, int type){
    ...
    - type: intero che √® definito in MessageTypes.h come SEND_FILES
    RETURN:
...
QJsonObject Serialize::newFileSerialize(QString filename,int id, int type){
    ...
    - type: intero che basandomi sul file MessageTypes.h mi dice cosa devo fare, il tipo che puÚ esere passato qui Ë
    RETURN:
    - una Qstring che contiene il tutto serializzano come QJson
    */
...
QJsonObject Serialize::renameFileSerialize(QString oldName, QString newName, int type){
    ...
    - type: intero che basandomi sul file MessageTypes.h mi dice cosa devo fare, il tipo che puÚ esere passato qui Ë RENAME
    RETURN:
    - una Qstring che contiene il tutto serializzano come QJson
    */
    QJsonObject obj;
...
QJsonObject Serialize::sharedFileAcquisitionSerialize(QString URI, int type){
    ...
    - type: intero che basandomi sul file MessageTypes.h mi dice cosa devo fare, il tipo che puÚ esere passato qui Ë SHARE
    RETURN:
    - una Qstring che contiene il tutto serializzano come QJson
    */
    QJsonObject obj;
...
QJsonObject Serialize::messageSerialize(int fileId, Message message, int type)
{
    ...
    - type: intero che basandomi sul file MessageTypes.h mi dice cosa devo fare, qui √® accettato solo il tipo MESSAGE che indica sul client di inviare un messaggio
